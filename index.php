...
echo "input[type=submit] {display: inline-block; padding: 0px 0px; margin: 10px 10px; cursor: pointer; background-color: #FF0000; color: white; border: none; border-radius: 2px;}\n";
echo "</style>\n";
