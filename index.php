...
echo "input[type=submit] {display: inline-block; padding: 2px 2px; margin: 0px 0px; cursor: pointer; background-color: #FF0000; color: white; border: none; border-radius: 2px;}\n";
echo "</style>\n";
